$(document).ready(function () {
    ...
    function toggleMenu(marginLeft, marginMain) {
        var emailList =
            $(window).width() <= 768 && $(window).width() > 640 ? 320 : 360;
        ...
        if ($(".mainpanel").css("position") === "relative") {
            ...
            $(".emailcontent, .email-options").animate(
                { left: marginMain },
                "fast",
            );
            ...
            $(".logopanel, .leftpanel").animate(
                { marginLeft: marginLeft },
                "fast",
            );
            $(".headerbar, .mainpanel").animate(
                { marginLeft: marginMain },
                "fast",
            );
            ...
            if ($(".nav-horizontal").css("position") == "relative") {
                ...
                if ($(".leftpanel .nav-horizontal").length > 0) {
                    ...
                    $(".nav-horizontal > li > a").each(function () {
                        ...
                        if (
                            $(this).parent().find(".dropdown-menu").length > 0
                        ) {
