...
@section('content')
    ...
    ">
        <center>
            ...
            <br>
            <a href="{{ url('/') }}">
                <button type="button" class="btn btn-success btn-lg" data-toggle="tooltip" title="Kembali kehalaman depan">
                    <span class="glyphicon glyphicon-home"></span>
                    Home
                </button>
            </a>

            <button class="btn btn-primary btn-lg" data-toggle="modal" data-target=".bs-modal-sm"
                style="margin: 15px 0 15px 0;" id="logtooltip" title="Login ke halaman Anda">
                        ...
                        <div class="tab-pane fade active in" id="signin">
                            <form method="POST" action="{{ route('login.process') }}">
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <button id="signin" type="submit" class="btn btn-success">
                                                Login
                                            </button>
