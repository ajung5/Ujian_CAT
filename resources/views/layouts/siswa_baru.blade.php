...
<head>
    ...
    <link rel="preload" href="{{ asset('assets/assets/libs/font-awesome/fonts/fontawesome-webfont.woff2?v=4.7.0') }}"
        as="font" type="font/woff2" crossorigin>

    <link type="text/css" href="{{ url('/assets/assets/libs/font-awesome/css/font-awesome.min.css') }}"
        rel="stylesheet">
...
<body class="layout-container ls-top-navbar si-l3-md-up" onkeydown="return (event.keyCode != 116)">
    ...
    ">
        ...
        @php
            $foto = !empty(auth()->user()->gambar) ? auth()->user()->gambar : 'siswa.png';
        @endphp
        ...
        <ul class="nav navbar-nav pull-xs-right">
            <li class="nav-item dropdown">
                ...
                "
                    ...
                    <img src="{{ url('/img/' . $foto) }}" alt="Avatar" class="img-circle" width="40">
                </a>
    ...
    "
        style="background:#fff !important;" data-scrollable>
        ...
        <ul class="sidebar-menu">
            ...
            <li
                ...
                {{ $url === 'siswa' ? 'active' : '' }}
            ">
                <a class="sidebar-menu-button" href="{{ route('siswa.index') }}">
                    <i class="
                        sidebar-menu-icon
                        fa
                        fa-home
            ...
            ">
                <a class="sidebar-menu-button" href="{{ route('siswa.profile') }}">
                    <i class="
                        sidebar-menu-icon
                        fa
                        fa-user
            ...
            @if (auth()->user()->status === 'S')
                ...
                {{ $url === 'latihan' ? 'active' : '' }}
            ">
                    <a class="sidebar-menu-button" href="{{ route('siswa.latihan') }}">
                        <i class="
                        sidebar-menu-icon
                        fa
                        fa-pencil-square-o
            ...
            ">
                    <a class="sidebar-menu-button" href="{{ route('siswa.results') }}">
                        <i class="
                        sidebar-menu-icon
                        fa
                        fa-book
            ...
            ">
                    <a class="sidebar-menu-button" href="{{ route('siswa.soal') }}">
                        <i class="
                        sidebar-menu-icon
                        fa
                        fa-list-alt
