        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered" id="tabelsoal">
                    ...
                    <tbody>
                        @forelse ($jawabs as $jawab)
                            <tr id="class-row-{{ $jawab->id_kelas }}">
                                <td>
                                    {{ $jawab->nama_kelas }}
                                </td>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('guru.results.class-detail', [
                                        'id' => $jawab->id_kelas,
                                        'idSoal' => $soal->id,
                                    ]) }}"
                                        class="
                                ...
                                ">
                                    ...
                                    <a href="{{ route('guru.results.class.export', [
                                        'id' => $jawab->id_kelas,
                                        'idSoal' => $soal->id,
                                    ]) }}"
                                        class="
                                ...
                                ">
                                    ...
                                    <a href="{{ route('guru.results.class.display', [
                                        'id' => $jawab->id_kelas,
                                        'idSoal' => $soal->id,
                                    ]) }}"
                                        class="
                                ...
                                "
                                    ...
                                    btn-delete-class
                                "
                                        data-class-id="{{ $jawab->id_kelas }}" data-exam-id="{{ $soal->id }}">
                        ...
                        <li class="media">
                            <div class="media-left">
                                <img class="
                                    ...
                                    img-thumbnail
                                "
                                    src="{{ asset('img/' . basename($gambar)) }}" width="45" alt="">
                            </div>
                            ...
                            <div class="media-body">
                                ...
                                <small class="date">
                                    ...
                                    {{ \Illuminate\Support\Carbon::parse($data->created_at)->format('d-m-Y') }}
                                </small>
                            </div>
                        </li>
                    @endforeach
                ...
                .on(
                    ...
                    function() {
                        ...
                        $.ajax({
                            ...
                            url: '{{ route('guru.results.class.destroy') }}',
