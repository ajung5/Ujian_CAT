...
@section('content')
    <div class="col-sm-12 col-md-8 col-lg-8 dash-left">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="background: #072047; color: #fff"> Profil Sekolah </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-3 col-lg-3 wrap-data-sekolah" align="center">
                        <?php if($school->logo != ""){ ?>
                        <img alt="Sch Pic" src="{{ url('img/' . $school->logo) }}" width="150px"
                            class="img-rounded img-thumbnail" style="margin-bottom: 15px">
                        <?php }else{ ?>
                        <img alt="Sch Pic" src="{{ url('img/noimage.jpg') }}" width="150px"
                            class="img-rounded img-thumbnail" style="margin-bottom: 15px">
                        <?php } ?>
                    </div>
                    <div class=" col-md-9 col-lg-9 wrap-data-sekolah">
                        ...
                        <button class="btn btn-primary" type="button" id="btn-ubah-sekolah">Ubah Data Sekolah</button>
                    </div>
                    <div id="wrap-ubah-sekolah" style="margin:0; display: none;">
                        <div class="well" style="margin: 0;">
                            <div id="formupdate" class="form-horizontal" style="margin: 0;">
                                {!! csrf_field() !!}
                                <div class="form-group">
                                    <label for="nama_sekolah" class="col-sm-2 control-label">Nama</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label for="alamat_sekolah" class="col-sm-2 control-label">Alamat</label>
                                    <div class="col-sm-10">
                                        <textarea type="text" name="alamat_sekolah" id="alamat_sekolah" class="form-control">{{ $school->alamat }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="motto_sekolah" class="col-sm-2 control-label">Motto</label>
                                    <div class="col-sm-10">
                                        <textarea type="text" name="motto_sekolah" id="motto_sekolah" class="form-control">{{ $school->motto }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="nama" class="col-sm-2 control-label">Foto</label>
                                    <div class="col-sm-10">
                                        <form action="{{ url('/upload-foto-sekolah') }}" class="dropzone">
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <input type="hidden" id="id_sekolah" name="id_sekolah"
                                                value="{{ $school->id }}">
                                            <div class="fallback">
                                                <input name="file_sekolah" type="file" multiple />
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button type="button" id="btnupdate-sekolah" class="btn btn-primary">Ubah</button>
                                        <button type="button" id="batal-sekolah" class="btn btn-danger">Batal</button>
                                        <img src="{{ url('/img/ajax-loader.gif') }}" alt="" id="loading-sekolah"
                                            style="display: none;">
                                        <div id="notif-sekolah" style="display: none; margin-top: 15px"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-3 col-lg-3 wrap-data-profil" align="center">
                        <?php if($user->gambar != ""){ ?>
                        <img alt="User Pic" src="{{ url('img/' . $user->gambar) }}" width="150px"
                            class="img-rounded img-thumbnail" style="margin-bottom: 15px">
                        <?php }else{ ?>
                        <img alt="User Pic" src="{{ url('img/noimage.jpg') }}" width="150px"
                            class="img-rounded img-thumbnail" style="margin-bottom: 15px">
                        <?php } ?>
                    </div>
                            ...
                            <div id="formupdate" class="form-horizontal" style="margin: 0;">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <img src="{{ url('/img/ajax-loader.gif') }}" alt="" id="loading"
                                            style="display: none;">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <a href="{{ url('/aktifitas') }}" class="btn btn-success"
                    style="display: block; width: 100%; margin: 10px 0 0 0">Selengkapnya</a>
            </div>
        </div>
    </div>
    @push('scripts')
                ...
                $('#btnupdate-sekolah').click(function() {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            motto_sekolah: $('#motto_sekolah').val()
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#btnupdate-sekolah").click(function() {
                $("#btnupdate-sekolah").hide();
                $("#batal-sekolah").hide();
                $("#loading-sekolah").show();
                var id = $("#id_sekolah").val();
                var nama_sekolah = $("#nama_sekolah").val();
                var alamat_sekolah = $("#alamat_sekolah").val();
                var motto_sekolah = $("#motto_sekolah").val();
                var datastring = "nama_sekolah=" + nama_sekolah + "&alamat_sekolah=" + alamat_sekolah +
                    "&motto_sekolah=" + motto_sekolah + "&id=" + id;
                $.ajax({
                    type: "POST",
                    url: "{{ url('/update-profil-sekolah') }}",
                    data: datastring,
                    success: function(data) {
                        if (data == "berhasil") {
                            $("#loading-sekolah").hide();
                            $("#notif-sekolah").removeClass('alert alert-danger').addClass(
                                'alert alert-info').html(
                                'Profil sekolah berhasil diupdate.').fadeIn(250);
                            $("#btnupdate-sekolah").show();
                            $("#batal-sekolah").show();
                            window.location.href = "{{ url('/profil-guru') }}";
                        } else {
                            $("#loading-sekolah").hide();
                            $("#notif-sekolah").removeClass('alert alert-info').addClass(
                                'alert alert-danger').html(data).fadeIn(250);
                            $("#btnupdate-sekolah").show();
                            $("#batal-sekolah").show();
                        }
                    }
            ...
            $("#btnupdate").click(function() {
                ...
                var datastring = "nama=" + nama + "&nis=" + nis + "&jk=" + jk + "&email=" + email +
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == "berhasil") {
                            $("#loading").hide();
                            $("#notif").removeClass('alert alert-danger').addClass(
                                    'alert alert-info').html('Profil berhasil diupdate.')
                                .fadeIn(250);
                            $("#btnupdate").show();
                            $("#batal").show();
                            window.location.href = "{{ url('/profil-guru') }}";
                            ...
                            $("#loading").hide();
                            $("#notif").removeClass('alert alert-info').addClass(
                                'alert alert-danger').html(data).fadeIn(250);
                            $("#btnupdate").show();
                            $("#batal").show();
                        }
