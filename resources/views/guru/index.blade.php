                ...
                <div class="row">
                    <div class="col-sm-4 col-md-4">
                        @if (empty($user->gambar))
                            <img src="{{ asset('img/noimage.jpg') }}" alt="Foto Guru" class="img-rounded img-responsive">
                        @else
                    ...
                    @forelse ($aktifitas as $data)
                        ...
                        <li class="media">
                            <div class="media-left">
                                <a href="#">
                                    <img class="media-object img-thumbnail" src="{{ asset('img/' . $gambarAktifitas) }}"
                                        alt="{{ $data->nama_user }}">
                                </a>
                            </div>
