                        ...
                        >
                            ...
                            <td>
                                ...
                                <input
                                    ...
                                    "
                                    data-id="{{ $daftarkelas->id }}"
                                    id="nama{{ $daftarkelas->id }}"
                                    value="{{ $daftarkelas->nama }}"
                                    style="display:none;"
                                >
    ...
    $('.input-nama-kelas').on(
        ...
        function (event) {
            ...
            $.ajax({
                ...
                url:
                    '{{ route('guru.kelas.update-inline') }}',
