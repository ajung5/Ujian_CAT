...
<center>
    ...
    <button class="btn btn-primary btn-lg" href="#signup" data-toggle="modal" data-target=".bs-modal-sm"
        style="margin: 15px 0 0 0;"><span class="glyphicon glyphicon-lock"></span> Login</button>
</center>
<br>
<hr class="prettyline">
</div>
            ...
            <div class="modal-body">
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade in" id="why">
                        <p>Aplikasi ujian ini di kembangkan dengan desain responsive, sehingga bisa diakses dengan baik
                            oleh berbagai perangkat.</p>
                        <p></p><br> Jika mengalami kendala silahkan sampaikan ke <a
                            mailto:href="support@tipa.co.id"></a>Support@Tipa.co.id</a> untuk mendapatkan bantuan
                        teknis.</p>
                    </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input required="" id="userid" name="userid" type="text"
                                            class="form-control" placeholder="JoeSixpack" class="input-medium"
                                            required="">
                                    </div>
                                </div>
                                    ...
                                    <div class="controls">
                                        <label class="checkbox inline" for="rememberme-0">
                                            <input type="checkbox" name="rememberme" id="rememberme-0"
                                                value="Remember me" style="margin: 0 0 0 0;">
