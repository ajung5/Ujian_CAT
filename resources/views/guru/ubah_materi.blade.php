            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="judul" value="{{ $materi->judul }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="isi">{{ $materi->isi }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <form action="{{ route('guru.materi.image') }}" method="POST" enctype="multipart/form-data"
                                class="dropzone" id="materi-edit-dropzone">
                                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="status" value="N" @checked($materi->status === 'N')>
                                Tidak tampil
                            </label>

                            <label class="radio-inline">
                                <input type="radio" name="status" value="Y" @checked($materi->status === 'Y')>
                                Tampil
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        ">
                            ...
                            <a href="{{ route('guru.materi.detail', $materi->id) }}" class="btn btn-danger btn-sm">
                                Batal
                            </a>
                        </div>
                    </div>
                        ...
                        success: function(data) {
                            ...
                            if (data === 'ok') {
                                ...
                                window.location.href =
                                    '{{ route('guru.materi.detail', $materi->id) }}';
