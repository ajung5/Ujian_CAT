        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul class="nav nav-tabs">
                    <li role="presentation" class="{{ $activeTab === 'siswa' ? 'active' : '' }}">
                        <a href="{{ route('guru.siswa', ['tab' => 'siswa']) }}">
                            Siswa
                            <span class="badge">
                                {{ $jumlahSiswa }}
                            </span>
                    ...
                    <li role="presentation" class="{{ $activeTab === 'calon' ? 'active' : '' }}">
                        <a href="{{ route('guru.siswa', ['tab' => 'calon']) }}">
                            Calon Siswa
                            <span class="badge">
                                {{ $jumlahCalonSiswa }}
                            </span>
                ...
                @if ($activeTab === 'siswa')
                    ...
                    <div class="student-toolbar">
                        <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#wrapsiswa">
                            <i class="fa fa-plus"></i>
                            Tambah Siswa
                        </button>

                        <a href="{{ asset('readfile/data.xls') }}" target="_blank" class="btn btn-success">
                            <i class="fa fa-download"></i>
                            Template Excel Siswa
                        </a>

                        <button type="button" class="btn btn-success" data-toggle="collapse" data-target="#uploadexcel">
                            <i class="fa fa-upload"></i>
                            Import Siswa
                        </button>
                    </div>

                    <div class="collapse" id="wrapsiswa" style="margin:15px 0;">
                        <div class="well">
                            <form id="form-tambah-siswa" class="form-horizontal">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="no_induk">
                                        NIS
                                    </label>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="jk">
                                        Jenis Kelamin
                                    </label>
                    ...
                    <div class="collapse" id="uploadexcel" style="margin:15px 0;">
                        <div class="well">
                            <form action="{{ route('guru.siswa.import') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="file_excel_siswa">
                                        File Excel
                                    </label>

                                    <div class="col-sm-10">
                                        <input type="file" name="file" id="file_excel_siswa" class="form-control"
                ...
                @else
                    <div class="student-toolbar">
                        <a href="{{ asset('readfile/datacalon.xls') }}" target="_blank" class="btn btn-success">
                            <i class="fa fa-download"></i>
                        ...
                        <form method="POST" action="{{ route('guru.siswa.candidates.destroy') }}"
                        ...
                        ">
                            ...
                            <button type="submit" class="btn btn-danger" @disabled($jumlahCalonSiswa === 0)>
                    ...
                    <div class="collapse" id="uploadexcelcalonsiswa" style="margin:15px 0;">
                        <div class="well">
                            <form action="{{ route('guru.siswa.candidate.import') }}" method="POST"
                                enctype="multipart/form-data" class="form-horizontal">
                                @csrf

                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="file_excel_calon">
                                        File Excel Calon
                                    </label>

                                    <div class="col-sm-10">
                                        <input type="file" name="filecalon" id="file_excel_calon"
                    ...
                    ">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    {{ $activeTab === 'siswa' ? 'Kelas' : 'Kelas Tujuan' }}
                                </th>
                        ...
                        <tbody>
                            @forelse ($users as $dataUser)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('guru.siswa.detail', $dataUser->id) }}"
                            ...
                            @empty
                                ...
                                <tr>
                                    <td colspan="{{ $activeTab === 'siswa' ? 7 : 8 }}" class="alert alert-danger">
                                        @if ($activeTab === 'siswa')
