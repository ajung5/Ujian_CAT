...
class GuruController extends Controller
{
    ...
    public function updateProfil(Request $request): Response
    {
        ...
        Aktifitas::create([
            'id_user' => auth()->id(),
            'nama' =>
                'Merubah data guru atas nama '.$user->nama,
        ]);
    ...
    public function updateProfilSekolah(
        ...
        $school->nama = trim(
            (string) $request->input('nama_sekolah')
        );
     ...
     * Upload logo Sekolah.
     */
    public function uploadFotoSekolah(
        Request $request
    ): Response {
        $validator = Validator::make(
            $request->all(),
    ...
    public function ubahKelas(Request $request)
    {
        ...
        Aktifitas::create([
            'id_user' => auth()->id(),
            'nama' =>
                'Merubah kelas dengan nama '.$kelas->nama,
        ]);
    ...
    public function tambahKelas(Request $request)
    {
        ...
        Aktifitas::create([
            'id_user' => auth()->id(),
            'nama' =>
                'Membuat kelas dengan nama '.$kelas->nama,
        ]);
    ...
    public function detailKelas(int $id): View
    {
        ...
        return view('guru.detailkelas', compact(
            'user',
            'school',
            'kelas',
            'kelassiswa',
